                                ...
                                foreach ($incomesOfLoggedUser as $incomeCategory) {
                                    ...
                                    foreach ($incomeDetails as $income) {
                                        if ($income['category_id'] == $incomeCategory['category_id']) {
                                            ...
                                            echo "<a href=\"edit_income.php?id={$income['income_id']}&startDate={$startDate}&endDate={$endDate}\" class=\"btn btn-sm btn-primary mr-1\"><i class=\"icon-pencil\"></i></a>";
                                ...
                                foreach ($expensesOfLoggedUser as $expenseCategory) {
                                    ...
                                    foreach ($expenseDetails as $expense) {
                                        if ($expense['category_id'] == $expenseCategory['category_id']) {
                                            ...
                                            echo "<td class=\"action\">";
                                            echo "<a href=\"edit_expense.php?id={$expense['expense_id']}&startDate={$startDate}&endDate={$endDate}\" class=\"btn btn-sm btn-primary mr-1\"><i class=\"icon-pencil\"></i></a>";
